...
In order for this to work you must modify the *_config.yml* file of your site to include something like __categorization: *category*__ and you must run your jekyll command with _--pagination <num>_
